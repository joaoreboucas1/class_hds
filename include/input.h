...
// JVR MOD: adding a new target to shoot for rho_cdm_0 using rho_cdm_ai
enum target_names {theta_s, theta_s_100, Omega_dcdmdr, omega_dcdmdr, Omega_scf, Omega_cdm, Omega_ini_dcdm, omega_ini_dcdm, sigma8, S8};
